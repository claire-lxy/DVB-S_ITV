...
public class GeneralSettingsActivity extends BaseItemFocusChangeActivity {
    ...
    void channelScanTime() {
        new EditTimeDialog().setCurrTime(DTVSettingManager.getInstance().getDTVProperty(HSetting_Enum_Property.AutoScanTime) * 1000)
                ...
                .setTimeListener(new EditTimeDialog.OnTimeListener() {
                    ...
                    public void time(int hour, int minute, int second) {
                        DTVSettingManager.getInstance().setDTVProperty(HSetting_Enum_Property.AutoScanTime, hour * 60 * 60 + minute * 60);
    ...
    protected void setup() {
        ...
        mTvChannelScanTime.setText(transTimeToStr(DTVSettingManager.getInstance().getDTVProperty(HSetting_Enum_Property.AutoScanTime)));
    }

    private void initData() {
        scartPosition = getSelectPosition(new int[]{0, 1}, DTVSettingManager.getInstance().getDTVProperty(HSetting_Enum_Property.TV_SCART));
        subtitleDisplayPosition = getSelectPosition(new int[]{0, 1}, DTVSettingManager.getInstance().getDTVProperty(HSetting_Enum_Property.SubtitleDisplay));
        pfTimeoutPosition = getSelectPosition(new int[]{5, 8, 10}, DTVSettingManager.getInstance().getDTVProperty(HSetting_Enum_Property.PD_dispalytime));
        ratioModePosition = getSelectPosition(new int[]{0, 1, 2}, DTVSettingManager.getInstance().getDTVProperty(HSetting_Enum_Property.ScreenRatio));
        aspectModePosition = getSelectPosition(new int[]{0, 1, 2, 3}, DTVSettingManager.getInstance().getDTVProperty(HSetting_Enum_Property.AspectRatio));
        switchChannelPosition = getSelectPosition(new int[]{0, 1}, DTVSettingManager.getInstance().getDTVProperty(HSetting_Enum_Property.PD_SwitchMode));
        firstAudioLanguagePosition = getSelectPosition(new int[]{0, 1}, DTVSettingManager.getInstance().getDTVProperty(HSetting_Enum_Property.AudioLanguage0));
        secondAudioLanguagePosition = getSelectPosition(new int[]{0, 1}, DTVSettingManager.getInstance().getDTVProperty(HSetting_Enum_Property.AudioLanguage1));
        subtitleLanguagePosition = getSelectPosition(new int[]{0, 1}, DTVSettingManager.getInstance().getDTVProperty(HSetting_Enum_Property.SubtitleLanguage));
        channelScanPosition = getSelectPosition(new int[]{0, 1}, DTVSettingManager.getInstance().getDTVProperty(HSetting_Enum_Property.AutoScanEnabled));
    }
