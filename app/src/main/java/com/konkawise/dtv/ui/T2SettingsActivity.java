...
public class T2SettingsActivity extends BaseItemFocusChangeActivity {
    ...
    private void initData() {
        antennaPowerPosition = getSelectPosition(new int[]{0, 1}, SWFtaManager.getInstance().getCommE2PInfo(HProperty_E.AntennaPower));
        lcnPosition = getSelectPosition(new int[]{0, 1}, SWFtaManager.getInstance().getCommE2PInfo(HProperty_E.ShowNoType));
                    ...
                    public void onDismiss(CommCheckItemDialog dialog, int position, String checkContent) {
                        switch (mCurrentSelectItem) {
                            case ITEM_ANTENNA_POWER:
                                ...
                                SWFtaManager.getInstance().setCommE2PInfo(HProperty_E.AntennaPower, antennaPowerPosition);
                                break;
                            ...
                            case ITEM_LCN:
                                ...
                                SWFtaManager.getInstance().setCommE2PInfo(HProperty_E.ShowNoType, lcnPosition);
                                break;
                            default:
                                break;
                        }
